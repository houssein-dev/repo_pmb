...
// +-------------------------------------------------+
// $Id: catal_form.tpl.php,v 1.205.2.1 2024/10/15 09:04:37 gneveu Exp $
...
<div id='el0Child' class='child' etirable='yes' title='".htmlentities($msg[236],ENT_QUOTES, $charset)."' >
    ...
    <div hidden id='el0Child_1' title='".htmlentities($msg[238],ENT_QUOTES, $charset)."' movable='yes'>
    ...
    <div hidden id='el0Child_2' title='".htmlentities($msg[239],ENT_QUOTES, $charset)."' movable='yes'>
	    <!--    Titre parall�le    -->
    ...
    <div hidden  id='el0Child_3' title='".htmlentities($msg[240],ENT_QUOTES, $charset)."' movable='yes'>
	    <!--    Compl�ment du titre    -->
    ...
    <div hidden  id='el0Child_4' title='".htmlentities($msg[241],ENT_QUOTES, $charset)."' movable='yes'>
	    <!--    Partie de    -->
	    <div class='row'>
...
if ($pmb_use_uniform_title) {
	...
	<!-- onglet 230 -->
	<div hidden  id='el230Parent' class='parent'>
		<h3>
...
<div hidden  id='el1Parent' class='parent'>
    <h3>
...
<div id='el1Child' class='child' etirable='yes' title='".htmlentities($msg[243],ENT_QUOTES, $charset)."'>
    <div id='el1Child_0' title='".htmlentities($msg[244],ENT_QUOTES, $charset)."' movable='yes'>
	    ...
	    <div class='row'>
	        ...
	        <!--    Fonction    -->
	        <div hidden  id='el1Child_1a' style='float:left;margin-right:10px;'>
    ...
    <div  hidden id='el1Child_2' title='".htmlentities($msg[246],ENT_QUOTES, $charset)."' movable='yes'>
	    <!--    Autres auteurs    -->
    ...
    <div id='el1Child_3' title='".htmlentities($msg[247],ENT_QUOTES, $charset)."' movable='yes'>
	    <!--    Auteurs secondaires     -->
	    <div hidden   id='el1Child_3a' class='row'>
	    	<div class='row'>
...
if (!empty($pmb_authors_qualification)) {
	...
	$authors_qualification_tpl = "
        <!--    Vedettes    -->
        <div  hidden id='el1Child_3b_others_vedettes' style='float:left;'>
...
<div id='el2Child' class='child' etirable='yes' title='".htmlentities($msg[249],ENT_QUOTES, $charset)."'>
	...
	<div id='el2Child_1' title='".htmlentities($msg[250],ENT_QUOTES, $charset)."' movable='yes'>
		<div class='row'>
		    ...
		    <div  hidden id='el2Child_2a' class='colonne_suite'>
	...
	<div  hidden id='el2Child_3' title='".htmlentities($msg[251],ENT_QUOTES, $charset)."' movable='yes'>
		...
		<div id='el2Child_4' title='".htmlentities($msg[252],ENT_QUOTES, $charset)."' movable='yes'>
		    ...
		    <div  hidden id='el2Child_6a' class='colonne_suite'>
	...
	<div hidden  id='el2Child_7' title='".htmlentities($msg[254],ENT_QUOTES, $charset)."' movable='yes'>
		<!--    Autre �diteur    -->
...
<div id='el4Child' class='child' etirable='yes' title='".htmlentities($msg[258],ENT_QUOTES, $charset)."'>
	...
	<div hidden  id='el4Child_1' title='".htmlentities($msg[260],ENT_QUOTES, $charset)."' movable='yes'>
	...
	<div  hidden id='el4Child_2' title='".htmlentities($msg[261],ENT_QUOTES, $charset)."' movable='yes'>
		<!--    Format    -->
	...
	<div  hidden id='el4Child_3' title='".htmlentities($msg[4050],ENT_QUOTES, $charset)."' movable='yes'>
		<!--    Prix    -->
	...
	<div  hidden id='el4Child_4' title='".htmlentities($msg[262],ENT_QUOTES, $charset)."' movable='yes'>
...
<div  hidden  id='el5Parent' class='parent'>
	<h3>
...
<div id='el6Child' class='child' etirable='yes' title='".htmlentities($msg[269],ENT_QUOTES, $charset)."'>
	...
	<div hidden  id='el6Child_1' title='".htmlentities($msg["indexint_catal_title"],ENT_QUOTES, $charset)."' movable='yes'>
	    <!--    indexation interne    -->
...
<div id='el7Child' class='child' etirable='yes' title='".htmlentities($msg[710], ENT_QUOTES, $charset)."'>
	...
	<div hidden  id='el7Child_1' title='".htmlentities($msg[711],ENT_QUOTES, $charset)."' movable='yes'>
	    <!--    Langues    -->
...
<div hidden  id='el8Parent' class='parent'>
	<h3>
...
if ($pmb_map_activate) {
	...
	<!-- onglet 14 -->
	<div  hidden id='el14Parent' class='parent'>
	<h3>
...
$ptab[15] = "
<!-- onglet 15 -->
<div  hidden id='el15Parent' class='parent'>
	<h3>
...
<div  hidden id='el10Parent' class='parent'>
<h3>
