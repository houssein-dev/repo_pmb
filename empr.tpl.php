...
// +-------------------------------------------------+
// $Id: empr.tpl.php,v 1.239.2.2 2024/10/18 07:31:21 tsamson Exp $
...
<div class='row'>
	...
	<input hidden type='button' class='bouton' value='".$msg['parcourir']."' onclick=\"openPopUp('./circ/setcb.php?f_cb='+this.form.f_cb.value, 'getcb')\" />
</div>
";

$empr_content_form_adr1 = "
<div  class='row'>
	<label for='form_adr1' class='etiquette'>etablissement</label>
</div>
<div  class='row'>
...
<div  class='row'>
	<label for='form_ville' class='etiquette'>filière</label>
</div>
<div  class='row'>
	<input type='text' class='saisie-20em' id='form_ville' name='form_ville' value=\"!!ville!!\" />
	<input hidden type='button'  class='bouton' value='".$msg['parcourir']."' onclick=\"var scp = this.form.form_cp.value; if(!this.form.form_cp.value) { scp=this.form.form_ville.value; } openPopUp('./select.php?what=codepostal&caller=empr_form&param1=form_ville&param2=form_cp&deb_rech='+".pmb_escape()."(scp), 'selector')\" />
</div>
";
...
<div  class='row'>
	...
	".($empr_sms_activation ? "<label hidden for='form_sms' class='etiquette'>".$msg['send_sms']."</label>
	<input hidden type='checkbox' id='form_sms' name='form_sms' value='1' !!sms!! />" : "")."
</div>
";
